                               ...
                               const int &channels, unsigned char *data)
{
  ...
  resource_out_file_content += "\nconst unsigned char " + resource_name + png_postfix + "_source" + "[] = {\n";
  ...
  resource_out_file_content +=
    "const int " + resource_name + png_postfix + "_width" + " = " + std::to_string(width) + ";\n";
  resource_out_file_content +=
    "const int " + resource_name + png_postfix + "_height" + " = " + std::to_string(height) + ";\n";
  resource_out_file_content +=
    "const int " + resource_name + png_postfix + "_channels" + " = " + std::to_string(channels) + ";\n";
...
{
  std::string resource_out_file_content;
  resource_out_file_content += "\nextern const unsigned char " + resource_name + png_postfix + "_source[];\n";
  resource_out_file_content += "extern const int " + resource_name + png_postfix + "_width;\n";
  resource_out_file_content += "extern const int " + resource_name + png_postfix + "_height;\n";
  resource_out_file_content += "extern const int " + resource_name + png_postfix + "_channels;\n";
  generated_out_file_content += resource_out_file_content;
}
