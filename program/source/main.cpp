...
int main(int argc, char *argv[])
{
  ...
  std::string generated_out_file_name = argv[argc - 1];
  ...
  for (int index = 2; index < argc - 1; index++)
  {
    ...
    if (resource_extension == "png")
    {
      ...
      if (generated_out_file_extension == "cpp")
      {
        resource_out_file_content += "\nconst int " + resource_name + postfix + "_width" + " = " +
                                     std::to_string(width) + ";\n";
        resource_out_file_content += "const int " + resource_name + postfix + "_height" + " = " +
                                     std::to_string(height) + ";\n";
        resource_out_file_content += "const int " + resource_name + postfix + "_channels" + " = " +
